...
describe("UpdateRecurrence", () => {
  ...
  it("should return null a recurrence updateed when updateRecurrenceRepository insert it", async () => {
  ...
  it("should rethrow if updateRecurrence of updateRecurrenceRepository throws", async () => {
    updateRecurrenceRepository.updateRecurrence.mockRejectedValueOnce(new Error("any_error"));
