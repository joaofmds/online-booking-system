...
describe("UpdateRatingResult", () => {
  ...
  it("should return null a ratingResult updateed when updateRatingResultRepository insert it", async () => {
  ...
  it("should rethrow if updateRatingResult of updateRatingResultRepository throws", async () => {
    updateRatingResultRepository.updateRatingResult.mockRejectedValueOnce(new Error("any_error"));
