export const useCasesToDo = {
  ...
  pushByOwner: [
    {
      rules: [
        "Owner pode mandar push ou email para usuário desde que esse usuário seja seu cliente",
      ],
    },
  ],
  ...
  services: {
    ...
    useCases: [
      "Retornar média de preço do salão pegando os preços e dividindo",
      "Retornar lista de todos os serviços cadastrados de owner active true e ordená-los pelo finalPrice ou appointmentsTotal",
    ],
  },
  request: [
    {
